...
echo "<h2>Подробная статистика заказов: </h2>";
  ...
  // dump($Arrayarticlesmonth,0,'$Arrayarticlesmonth');
    ...
    echo "<td>Телефон клиента <img src='data:image/png;base64,'></td>";
     if (!empty($ElementMail)) { echo "<td>Почта клиента <img src='data:image/png;base64,'></td>"; }
...
// dump($TopTelnumberarray,0,'$TopTelnumberarray');
   ...
   if (!empty($ElementMail)) {   echo "<td>{$OrderClientMail}</td>";  }
    echo "<td>{$OrderSku}</td>";
