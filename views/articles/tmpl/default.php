    ...
    echo " document.addEventListener('DOMContentLoaded',function(){";
      echo 'new Chartist.Line(".ct-chart", { ';
        ...
        echo "     }, { ";
          ...
          echo '<h1>Статистика '.$StatOrProduct.' за '.$monthnew.' '.$year.' ('.$countarticleinmonth.')</h1>';
          ...
          if (!empty($Arrayarticlesmonthtag[0])) {
            foreach ($Arrayarticlesmonthtag as $keyidarticles  => $valueddid) {
              ...
              if ($comparear) {
                ...
                echo "<td>Название <img src='data:image/png;base64,'></td>";
