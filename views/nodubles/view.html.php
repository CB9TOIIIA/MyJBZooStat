...
class MyjbzoostatViewNodubles extends JViewLegacy
{
    ...
    {
        JToolBarHelper::title( JText::_( 'Детектор Дублей' ) );
				...
				JToolBarHelper::divider();
								...
								$bar = JToolBar::getInstance('toolbar');
								$title = JText::_('Детектор Дублей');
								$dhtml = "<a href=\"/administrator/index.php?option=com_myjbzoostat&view=nodubles\" class=\"btn btn-small\"><i class=\"icon-warning\" title=\"$title\"></i>$title</a>";
								$bar->appendButton('Custom', $dhtml, 'list');
